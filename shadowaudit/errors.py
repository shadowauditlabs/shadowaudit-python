"""ShadowAudit exception hierarchy.

All ShadowAudit errors inherit from `ShadowAuditError`. Catch the base class to
handle any ShadowAudit failure; catch specific subclasses for targeted handling.
...
class ShadowAuditError(Exception):
    """Base class for all ShadowAudit errors."""


class ConfigurationError(ShadowAuditError, ValueError):
