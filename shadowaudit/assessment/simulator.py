"""Trace simulator — replays agent execution traces through ShadowAudit gate.
...
from shadowaudit.core.scorer import KeywordScorer, AdaptiveScorer
...
class TraceSimulator:
    """Replay agent tool call traces through ShadowAudit gate variants.
    ...
    def run(
        ...
        if summary.adaptive_additional_blocks > 0:
            summary.recommendation = (
                ...
                f"Consider ShadowAudit Enterprise for real-time adaptive enforcement."
            )
        else:
