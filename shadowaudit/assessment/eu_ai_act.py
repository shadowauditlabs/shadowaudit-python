...
from shadowaudit.assessment.owasp import get_coverage_summary
...
def generate_evidence_pack(
    data: AssessmentData,
    system_name: str = "ShadowAudit-Governed Agent",
    ...
    pack = EvidencePack(
        ...
        risk_management={
            ...
            "mitigation": "ShadowAudit Gate provides deterministic fail-closed enforcement with taxonomy-based thresholds.",
            "residual_risk": "Low — all high-risk tool calls are intercepted and scored before execution.",
        },
        data_governance={
            "description": "Training data governance is outside ShadowAudit scope. This section covers operational data.",
        ...
        technical_documentation={
            ...
            "architecture": "ShadowAudit sits between the agent and its tools. Gate evaluates every call before execution.",
            "components": [
        ...
        record_keeping={
            ...
            "verification_command": "shadowaudit verify --audit-log ./audit.db",
        ...
        cybersecurity={
            ...
            "mitigations": [
                ...
                "Insecure Plugin Design: ShadowAuditTool wrapper enforces access controls and input scoring.",
