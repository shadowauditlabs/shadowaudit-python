...
Maps ShadowAudit capabilities to the OWASP Agentic AI Top 10 risks.
...
_OWASP_COVERAGE: list[OWASPCoverageItem] = [
    OWASPCoverageItem(
        ...
        shadowaudit_feature="Gate evaluates payload content against risk keywords; blocks dangerous tool calls regardless of prompt origin.",
        notes="ShadowAudit does not inspect LLM prompts — it intercepts tool calls. This mitigates the execution phase of prompt injection.",
    ),
    OWASPCoverageItem(
        risk_id="AA02",
        ...
        shadowaudit_feature="N/A",
        notes="ShadowAudit governs tool calls, not output rendering. Use traditional output encoding.",
    ),
    OWASPCoverageItem(
        risk_id="AA03",
        ...
        covered=True,
        coverage_level="full",
        shadowaudit_feature="Taxonomy-based gate with per-category thresholds. Blocks unauthorized tool categories entirely.",
    ...
    OWASPCoverageItem(
        ...
        coverage_level="not_applicable",
        shadowaudit_feature="N/A",
        notes="Human-in-the-loop and output verification are outside ShadowAudit scope.",
    ),
    OWASPCoverageItem(
        risk_id="AA05",
    ...
    OWASPCoverageItem(
        ...
        covered=True,
        coverage_level="partial",
        shadowaudit_feature="Payload hashing in audit log. No raw payloads stored. Compliance reports map to PCI-DSS / SOX.",
    ...
    OWASPCoverageItem(
        ...
        covered=True,
        coverage_level="full",
        shadowaudit_feature="ShadowAuditTool wrapper enforces access controls, input scoring, and rate/velocity tracking per agent_id.",
    ...
    OWASPCoverageItem(
        ...
        covered=True,
        coverage_level="partial",
        shadowaudit_feature="Velocity tracking (V metric) detects tool-call spikes. FSM fail-closed on anomaly.",
    ...
    OWASPCoverageItem(
        ...
        coverage_level="not_applicable",
        shadowaudit_feature="N/A",
        notes="Use SCA tools (Snyk, Dependabot) for supply chain. ShadowAudit is runtime.",
    ),
    OWASPCoverageItem(
        risk_id="AA10",
        ...
        covered=True,
        coverage_level="partial",
        shadowaudit_feature="Command execution taxonomy with strict thresholds. Blocks shell escapes and dangerous system calls.",
