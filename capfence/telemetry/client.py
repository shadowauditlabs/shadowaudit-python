...
Sends anonymized gate decision metadata to the CapFence Cloud API.
...
Usage:
    ...
    client = TelemetryClient(api_key=os.getenv("CAPFENCE_API_KEY"))
...
Opt-in only. Set CAPFENCE_TELEMETRY=1 to enable.
"""
...
class TelemetryClient:
    ...
    DEFAULT_BASE_URL = "https://api.capfence.io/v1"
    TIMEOUT_SECONDS = 3
    MAX_QUEUE_SIZE = 1000
    ...
    def __init__(
        ...
        self._api_key = api_key or os.getenv("CAPFENCE_API_KEY")
        self._base_url = (base_url or os.getenv("CAPFENCE_BASE_URL") or self.DEFAULT_BASE_URL).rstrip("/")
        self._timeout = timeout
        self._enabled = os.getenv("CAPFENCE_TELEMETRY", "0") == "1" and self._api_key is not None
